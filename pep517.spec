...
Source0  : https://files.pythonhosted.org/packages/93/80/5398cb3bde7d188569b33a65df291bdcaee669c6228a858d539d83a1eef3/pep517-0.8.2.tar.gz
...
%prep
%setup -q -n pep517-0.8.2
cd %{_builddir}/pep517-0.8.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588304774
...
cp %{_builddir}/pep517-0.8.2/LICENSE %{buildroot}/usr/share/package-licenses/pep517/b2f7e71b77f14f21cd693e1c6fbe7236a8deac5f
cp %{_builddir}/pep517-0.8.2/tests/samples/pkg1/pkg1-0.5.dist-info/LICENSE %{buildroot}/usr/share/package-licenses/pep517/b2f7e71b77f14f21cd693e1c6fbe7236a8deac5f
cp %{_builddir}/pep517-0.8.2/tests/samples/pkg2/pkg2-0.5.dist-info/LICENSE %{buildroot}/usr/share/package-licenses/pep517/b2f7e71b77f14f21cd693e1c6fbe7236a8deac5f
